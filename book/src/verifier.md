...
```admonish note
If you've gone through fast-track migration, you do not need to follow the steps on this page.
```
...
The commands below will be using Foundry's `forge` utility, which you should have installed as a
[prerequisite](quickstart.md#prerequisites).
...
First, you must change your working directory to `crates/contracts/foundry` for the following commands to succeed:
```shell
